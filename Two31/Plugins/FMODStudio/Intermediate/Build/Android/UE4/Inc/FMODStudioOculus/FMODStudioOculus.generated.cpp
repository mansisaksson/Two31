...
void EmptyLinkFunctionForGeneratedCodeFMODStudioOculus() {}
class UScriptStruct* FFMODOculusRoomParameters::StaticStruct()
{
	...
	if (!Singleton)
	{
		...
		extern FMODSTUDIOOCULUS_API class UPackage* Z_Construct_UPackage_FMODStudioOculus();
		Singleton = GetStaticStruct(Z_Construct_UScriptStruct_FFMODOculusRoomParameters, Z_Construct_UPackage_FMODStudioOculus(), TEXT("FMODOculusRoomParameters"), sizeof(FFMODOculusRoomParameters), Get_Z_Construct_UScriptStruct_FFMODOculusRoomParameters_CRC());
	}
	return Singleton;
}
static FCompiledInDeferStruct Z_CompiledInDeferStruct_UScriptStruct_FFMODOculusRoomParameters(FFMODOculusRoomParameters::StaticStruct, TEXT("/Script/FMODStudioOculus"));
static struct FScriptStruct_FMODStudioOculus_StaticRegisterNativesFFMODOculusRoomParameters
{
	...
	IMPLEMENT_CLASS(UFMODOculusBlueprintStatics, 2540219052);
	void UFMODOculusSettings::StaticRegisterNativesUFMODOculusSettings()
	{
	}
	IMPLEMENT_CLASS(UFMODOculusSettings, 835622775);
...
// Cross Module References
	...
	FMODSTUDIOOCULUS_API class UPackage* Z_Construct_UPackage_FMODStudioOculus();
	UScriptStruct* Z_Construct_UScriptStruct_FFMODOculusRoomParameters()
	{
		UPackage* Outer=Z_Construct_UPackage_FMODStudioOculus();
		extern uint32 Get_Z_Construct_UScriptStruct_FFMODOculusRoomParameters_CRC();
		static UScriptStruct* ReturnStruct = FindExistingStructIfHotReload(Outer, TEXT("FMODOculusRoomParameters"), sizeof(FFMODOculusRoomParameters), Get_Z_Construct_UScriptStruct_FFMODOculusRoomParameters_CRC());
		if (!ReturnStruct)
		{
			ReturnStruct = new(EC_InternalUseOnlyConstructor, Outer, TEXT("FMODOculusRoomParameters"), RF_Public|RF_Transient|RF_Native) UScriptStruct(FObjectInitializer(), NULL, new UScriptStruct::TCppStructOps<FFMODOculusRoomParameters>, EStructFlags(0x00000001));
			UProperty* NewProp_RefFar = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("RefFar"), RF_Public|RF_Transient|RF_Native) UFloatProperty(CPP_PROPERTY_BASE(RefFar, FFMODOculusRoomParameters), 0x0000000000000005);
			UProperty* NewProp_RefNear = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("RefNear"), RF_Public|RF_Transient|RF_Native) UFloatProperty(CPP_PROPERTY_BASE(RefNear, FFMODOculusRoomParameters), 0x0000000000000005);
			UProperty* NewProp_RefDown = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("RefDown"), RF_Public|RF_Transient|RF_Native) UFloatProperty(CPP_PROPERTY_BASE(RefDown, FFMODOculusRoomParameters), 0x0000000000000005);
			UProperty* NewProp_RefUp = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("RefUp"), RF_Public|RF_Transient|RF_Native) UFloatProperty(CPP_PROPERTY_BASE(RefUp, FFMODOculusRoomParameters), 0x0000000000000005);
			UProperty* NewProp_RefRight = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("RefRight"), RF_Public|RF_Transient|RF_Native) UFloatProperty(CPP_PROPERTY_BASE(RefRight, FFMODOculusRoomParameters), 0x0000000000000005);
			UProperty* NewProp_RefLeft = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("RefLeft"), RF_Public|RF_Transient|RF_Native) UFloatProperty(CPP_PROPERTY_BASE(RefLeft, FFMODOculusRoomParameters), 0x0000000000000005);
			UProperty* NewProp_RoomDepth = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("RoomDepth"), RF_Public|RF_Transient|RF_Native) UFloatProperty(CPP_PROPERTY_BASE(RoomDepth, FFMODOculusRoomParameters), 0x0000000000000005);
			UProperty* NewProp_RoomHeight = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("RoomHeight"), RF_Public|RF_Transient|RF_Native) UFloatProperty(CPP_PROPERTY_BASE(RoomHeight, FFMODOculusRoomParameters), 0x0000000000000005);
			UProperty* NewProp_RoomWidth = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("RoomWidth"), RF_Public|RF_Transient|RF_Native) UFloatProperty(CPP_PROPERTY_BASE(RoomWidth, FFMODOculusRoomParameters), 0x0000000000000005);
	...
	uint32 Get_Z_Construct_UScriptStruct_FFMODOculusRoomParameters_CRC() { return 119830891U; }
	UFunction* Z_Construct_UFunction_UFMODOculusBlueprintStatics_SetEarlyReflectionsEnabled()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("SetEarlyReflectionsEnabled"), RF_Public|RF_Transient|RF_Native) UFunction(FObjectInitializer(), NULL, 0x04022401, 65535, sizeof(FMODOculusBlueprintStatics_eventSetEarlyReflectionsEnabled_Parms));
			CPP_BOOL_PROPERTY_BITMASK_STRUCT(bEnable, FMODOculusBlueprintStatics_eventSetEarlyReflectionsEnabled_Parms, bool);
			UProperty* NewProp_bEnable = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("bEnable"), RF_Public|RF_Transient|RF_Native) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(bEnable, FMODOculusBlueprintStatics_eventSetEarlyReflectionsEnabled_Parms), 0x0000000000000080, CPP_BOOL_PROPERTY_BITMASK(bEnable, FMODOculusBlueprintStatics_eventSetEarlyReflectionsEnabled_Parms), sizeof(bool), true);
			ReturnFunction->Bind();
	...
	UFunction* Z_Construct_UFunction_UFMODOculusBlueprintStatics_SetLateReverberationEnabled()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("SetLateReverberationEnabled"), RF_Public|RF_Transient|RF_Native) UFunction(FObjectInitializer(), NULL, 0x04022401, 65535, sizeof(FMODOculusBlueprintStatics_eventSetLateReverberationEnabled_Parms));
			CPP_BOOL_PROPERTY_BITMASK_STRUCT(bEnable, FMODOculusBlueprintStatics_eventSetLateReverberationEnabled_Parms, bool);
			UProperty* NewProp_bEnable = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("bEnable"), RF_Public|RF_Transient|RF_Native) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(bEnable, FMODOculusBlueprintStatics_eventSetLateReverberationEnabled_Parms), 0x0000000000000080, CPP_BOOL_PROPERTY_BITMASK(bEnable, FMODOculusBlueprintStatics_eventSetLateReverberationEnabled_Parms), sizeof(bool), true);
			ReturnFunction->Bind();
			ReturnFunction->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnFunction->GetOutermost()->GetMetaData();
	...
	UFunction* Z_Construct_UFunction_UFMODOculusBlueprintStatics_SetRoomParameters()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("SetRoomParameters"), RF_Public|RF_Transient|RF_Native) UFunction(FObjectInitializer(), NULL, 0x04422401, 65535, sizeof(FMODOculusBlueprintStatics_eventSetRoomParameters_Parms));
			UProperty* NewProp_Params = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("Params"), RF_Public|RF_Transient|RF_Native) UStructProperty(CPP_PROPERTY_BASE(Params, FMODOculusBlueprintStatics_eventSetRoomParameters_Parms), 0x0000000008000182, Z_Construct_UScriptStruct_FFMODOculusRoomParameters());
			ReturnFunction->Bind();
			ReturnFunction->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnFunction->GetOutermost()->GetMetaData();
	...
	UClass* Z_Construct_UClass_UFMODOculusBlueprintStatics()
	{
		...
		if (!OuterClass)
		{
			...
			Z_Construct_UPackage_FMODStudioOculus();
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				OuterClass->AddFunctionToFunctionMap(Z_Construct_UFunction_UFMODOculusBlueprintStatics_SetEarlyReflectionsEnabled()); // 3078519849
				OuterClass->AddFunctionToFunctionMap(Z_Construct_UFunction_UFMODOculusBlueprintStatics_SetLateReverberationEnabled()); // 828017533
				OuterClass->AddFunctionToFunctionMap(Z_Construct_UFunction_UFMODOculusBlueprintStatics_SetRoomParameters()); // 578049746
	...
	static FCompiledInDefer Z_CompiledInDefer_UClass_UFMODOculusBlueprintStatics(Z_Construct_UClass_UFMODOculusBlueprintStatics, TEXT("UFMODOculusBlueprintStatics"));
...
PRAGMA_DISABLE_DEPRECATION_WARNINGS
				UProperty* NewProp_RoomParameters = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("RoomParameters"), RF_Public|RF_Transient|RF_Native) UStructProperty(CPP_PROPERTY_BASE(RoomParameters, UFMODOculusSettings), 0x0000000000004001, Z_Construct_UScriptStruct_FFMODOculusRoomParameters());
				CPP_BOOL_PROPERTY_BITMASK_STRUCT(bLateReverberationEnabled, UFMODOculusSettings, bool);
				UProperty* NewProp_bLateReverberationEnabled = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("bLateReverberationEnabled"), RF_Public|RF_Transient|RF_Native) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(bLateReverberationEnabled, UFMODOculusSettings), 0x0000000000004001, CPP_BOOL_PROPERTY_BITMASK(bLateReverberationEnabled, UFMODOculusSettings), sizeof(bool), true);
				CPP_BOOL_PROPERTY_BITMASK_STRUCT(bEarlyReflectionsEnabled, UFMODOculusSettings, bool);
				UProperty* NewProp_bEarlyReflectionsEnabled = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("bEarlyReflectionsEnabled"), RF_Public|RF_Transient|RF_Native) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(bEarlyReflectionsEnabled, UFMODOculusSettings), 0x0000000000004001, CPP_BOOL_PROPERTY_BITMASK(bEarlyReflectionsEnabled, UFMODOculusSettings), sizeof(bool), true);
				CPP_BOOL_PROPERTY_BITMASK_STRUCT(bOculusEnabled, UFMODOculusSettings, bool);
				UProperty* NewProp_bOculusEnabled = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("bOculusEnabled"), RF_Public|RF_Transient|RF_Native) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(bOculusEnabled, UFMODOculusSettings), 0x0000000000004001, CPP_BOOL_PROPERTY_BITMASK(bOculusEnabled, UFMODOculusSettings), sizeof(bool), true);
PRAGMA_ENABLE_DEPRECATION_WARNINGS
	...
	static FCompiledInDefer Z_CompiledInDefer_UClass_UFMODOculusSettings(Z_Construct_UClass_UFMODOculusSettings, TEXT("UFMODOculusSettings"));
	DEFINE_VTABLE_PTR_HELPER_CTOR(UFMODOculusSettings);
	UPackage* Z_Construct_UPackage_FMODStudioOculus()
	{
