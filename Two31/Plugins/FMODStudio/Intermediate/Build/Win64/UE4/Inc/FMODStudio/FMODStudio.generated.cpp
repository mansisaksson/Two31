...
void EmptyLinkFunctionForGeneratedCodeFMODStudio() {}
...
class UScriptStruct* FFMODEventInstance::StaticStruct()
{
	...
	if (!Singleton)
	{
		...
		extern FMODSTUDIO_API class UPackage* Z_Construct_UPackage_FMODStudio();
		Singleton = GetStaticStruct(Z_Construct_UScriptStruct_FFMODEventInstance, Z_Construct_UPackage_FMODStudio(), TEXT("FMODEventInstance"), sizeof(FFMODEventInstance), Get_Z_Construct_UScriptStruct_FFMODEventInstance_CRC());
	}
	return Singleton;
}
static FCompiledInDeferStruct Z_CompiledInDeferStruct_UScriptStruct_FFMODEventInstance(FFMODEventInstance::StaticStruct, TEXT("/Script/FMODStudio"));
static struct FScriptStruct_FMODStudio_StaticRegisterNativesFFMODEventInstance
{
	...
	IMPLEMENT_CLASS(UFMODBlueprintStatics, 3642442343);
static class UEnum* EFMODSpeakerMode_StaticEnum()
{
	...
	if (!Singleton)
	{
		...
		extern FMODSTUDIO_API class UPackage* Z_Construct_UPackage_FMODStudio();
		Singleton = GetStaticEnum(Z_Construct_UEnum_FMODStudio_EFMODSpeakerMode, Z_Construct_UPackage_FMODStudio(), TEXT("EFMODSpeakerMode"));
	}
	return Singleton;
}
static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_EFMODSpeakerMode(EFMODSpeakerMode_StaticEnum, TEXT("/Script/FMODStudio"));
	void UFMODSettings::StaticRegisterNativesUFMODSettings()
	{
	}
	IMPLEMENT_CLASS(UFMODSettings, 1832275895);
	void UFMODSnapshotReverb::StaticRegisterNativesUFMODSnapshotReverb()
	{
	}
	IMPLEMENT_CLASS(UFMODSnapshotReverb, 1601513705);
...
// Cross Module References
	...
	FMODSTUDIO_API class UPackage* Z_Construct_UPackage_FMODStudio();
	UFunction* Z_Construct_UDelegateFunction_FMODStudio_OnTimelineBeat__DelegateSignature()
	{
		...
		UObject* Outer=Z_Construct_UPackage_FMODStudio();
		static UFunction* ReturnFunction = NULL;
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("OnTimelineBeat__DelegateSignature"), RF_Public|RF_Transient|RF_Native) UDelegateFunction(FObjectInitializer(), NULL, 0x00130000, 65535, sizeof(_Script_FMODStudio_eventOnTimelineBeat_Parms));
			UProperty* NewProp_TimeSignatureLower = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("TimeSignatureLower"), RF_Public|RF_Transient|RF_Native) UIntProperty(CPP_PROPERTY_BASE(TimeSignatureLower, _Script_FMODStudio_eventOnTimelineBeat_Parms), 0x0000000000000080);
			UProperty* NewProp_TimeSignatureUpper = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("TimeSignatureUpper"), RF_Public|RF_Transient|RF_Native) UIntProperty(CPP_PROPERTY_BASE(TimeSignatureUpper, _Script_FMODStudio_eventOnTimelineBeat_Parms), 0x0000000000000080);
			UProperty* NewProp_Tempo = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("Tempo"), RF_Public|RF_Transient|RF_Native) UFloatProperty(CPP_PROPERTY_BASE(Tempo, _Script_FMODStudio_eventOnTimelineBeat_Parms), 0x0000000000000080);
			UProperty* NewProp_Position = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("Position"), RF_Public|RF_Transient|RF_Native) UIntProperty(CPP_PROPERTY_BASE(Position, _Script_FMODStudio_eventOnTimelineBeat_Parms), 0x0000000000000080);
			UProperty* NewProp_Beat = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("Beat"), RF_Public|RF_Transient|RF_Native) UIntProperty(CPP_PROPERTY_BASE(Beat, _Script_FMODStudio_eventOnTimelineBeat_Parms), 0x0000000000000080);
			UProperty* NewProp_Bar = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("Bar"), RF_Public|RF_Transient|RF_Native) UIntProperty(CPP_PROPERTY_BASE(Bar, _Script_FMODStudio_eventOnTimelineBeat_Parms), 0x0000000000000080);
			ReturnFunction->Bind();
	...
	UFunction* Z_Construct_UDelegateFunction_FMODStudio_OnTimelineMarker__DelegateSignature()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("OnTimelineMarker__DelegateSignature"), RF_Public|RF_Transient|RF_Native) UDelegateFunction(FObjectInitializer(), NULL, 0x00130000, 65535, sizeof(_Script_FMODStudio_eventOnTimelineMarker_Parms));
			UProperty* NewProp_Position = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("Position"), RF_Public|RF_Transient|RF_Native) UIntProperty(CPP_PROPERTY_BASE(Position, _Script_FMODStudio_eventOnTimelineMarker_Parms), 0x0000000000000080);
			UProperty* NewProp_Name = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("Name"), RF_Public|RF_Transient|RF_Native) UStrProperty(CPP_PROPERTY_BASE(Name, _Script_FMODStudio_eventOnTimelineMarker_Parms), 0x0000000000000080);
			ReturnFunction->Bind();
			ReturnFunction->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnFunction->GetOutermost()->GetMetaData();
	...
	UFunction* Z_Construct_UDelegateFunction_FMODStudio_OnEventStopped__DelegateSignature()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("OnEventStopped__DelegateSignature"), RF_Public|RF_Transient|RF_Native) UDelegateFunction(FObjectInitializer(), NULL, 0x00130000, 65535);
			ReturnFunction->Bind();
			ReturnFunction->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnFunction->GetOutermost()->GetMetaData();
	...
	UFunction* Z_Construct_UFunction_UFMODAudioComponent_GetParameter()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("GetParameter"), RF_Public|RF_Transient|RF_Native) UFunction(FObjectInitializer(), NULL, 0x04020401, 65535, sizeof(FMODAudioComponent_eventGetParameter_Parms));
			UProperty* NewProp_ReturnValue = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("ReturnValue"), RF_Public|RF_Transient|RF_Native) UFloatProperty(CPP_PROPERTY_BASE(ReturnValue, FMODAudioComponent_eventGetParameter_Parms), 0x0000000000000580);
			UProperty* NewProp_Name = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("Name"), RF_Public|RF_Transient|RF_Native) UNameProperty(CPP_PROPERTY_BASE(Name, FMODAudioComponent_eventGetParameter_Parms), 0x0000000000000080);
			ReturnFunction->Bind();
			ReturnFunction->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnFunction->GetOutermost()->GetMetaData();
	...
	UFunction* Z_Construct_UFunction_UFMODAudioComponent_GetTimelinePosition()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("GetTimelinePosition"), RF_Public|RF_Transient|RF_Native) UFunction(FObjectInitializer(), NULL, 0x04020401, 65535, sizeof(FMODAudioComponent_eventGetTimelinePosition_Parms));
			UProperty* NewProp_ReturnValue = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("ReturnValue"), RF_Public|RF_Transient|RF_Native) UIntProperty(CPP_PROPERTY_BASE(ReturnValue, FMODAudioComponent_eventGetTimelinePosition_Parms), 0x0000000000000580);
			ReturnFunction->Bind();
			ReturnFunction->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnFunction->GetOutermost()->GetMetaData();
	...
	UFunction* Z_Construct_UFunction_UFMODAudioComponent_IsPlaying()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("IsPlaying"), RF_Public|RF_Transient|RF_Native) UFunction(FObjectInitializer(), NULL, 0x04020401, 65535, sizeof(FMODAudioComponent_eventIsPlaying_Parms));
			CPP_BOOL_PROPERTY_BITMASK_STRUCT(ReturnValue, FMODAudioComponent_eventIsPlaying_Parms, bool);
			UProperty* NewProp_ReturnValue = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("ReturnValue"), RF_Public|RF_Transient|RF_Native) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(ReturnValue, FMODAudioComponent_eventIsPlaying_Parms), 0x0000000000000580, CPP_BOOL_PROPERTY_BITMASK(ReturnValue, FMODAudioComponent_eventIsPlaying_Parms), sizeof(bool), true);
			ReturnFunction->Bind();
			ReturnFunction->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnFunction->GetOutermost()->GetMetaData();
	...
	UFunction* Z_Construct_UFunction_UFMODAudioComponent_SetEvent()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("SetEvent"), RF_Public|RF_Transient|RF_Native) UFunction(FObjectInitializer(), NULL, 0x04020401, 65535, sizeof(FMODAudioComponent_eventSetEvent_Parms));
			UProperty* NewProp_NewEvent = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("NewEvent"), RF_Public|RF_Transient|RF_Native) UObjectProperty(CPP_PROPERTY_BASE(NewEvent, FMODAudioComponent_eventSetEvent_Parms), 0x0000000000000080, Z_Construct_UClass_UFMODEvent_NoRegister());
			ReturnFunction->Bind();
			ReturnFunction->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnFunction->GetOutermost()->GetMetaData();
	...
	UFunction* Z_Construct_UFunction_UFMODAudioComponent_SetParameter()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("SetParameter"), RF_Public|RF_Transient|RF_Native) UFunction(FObjectInitializer(), NULL, 0x04020401, 65535, sizeof(FMODAudioComponent_eventSetParameter_Parms));
			UProperty* NewProp_Value = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("Value"), RF_Public|RF_Transient|RF_Native) UFloatProperty(CPP_PROPERTY_BASE(Value, FMODAudioComponent_eventSetParameter_Parms), 0x0000000000000080);
			UProperty* NewProp_Name = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("Name"), RF_Public|RF_Transient|RF_Native) UNameProperty(CPP_PROPERTY_BASE(Name, FMODAudioComponent_eventSetParameter_Parms), 0x0000000000000080);
			ReturnFunction->Bind();
			ReturnFunction->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnFunction->GetOutermost()->GetMetaData();
	...
	UFunction* Z_Construct_UFunction_UFMODAudioComponent_SetPaused()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("SetPaused"), RF_Public|RF_Transient|RF_Native) UFunction(FObjectInitializer(), NULL, 0x04020401, 65535, sizeof(FMODAudioComponent_eventSetPaused_Parms));
			CPP_BOOL_PROPERTY_BITMASK_STRUCT(paused, FMODAudioComponent_eventSetPaused_Parms, bool);
			UProperty* NewProp_paused = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("paused"), RF_Public|RF_Transient|RF_Native) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(paused, FMODAudioComponent_eventSetPaused_Parms), 0x0000000000000080, CPP_BOOL_PROPERTY_BITMASK(paused, FMODAudioComponent_eventSetPaused_Parms), sizeof(bool), true);
			ReturnFunction->Bind();
			ReturnFunction->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnFunction->GetOutermost()->GetMetaData();
	...
	UFunction* Z_Construct_UFunction_UFMODAudioComponent_SetPitch()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("SetPitch"), RF_Public|RF_Transient|RF_Native) UFunction(FObjectInitializer(), NULL, 0x04020401, 65535, sizeof(FMODAudioComponent_eventSetPitch_Parms));
			UProperty* NewProp_pitch = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("pitch"), RF_Public|RF_Transient|RF_Native) UFloatProperty(CPP_PROPERTY_BASE(pitch, FMODAudioComponent_eventSetPitch_Parms), 0x0000000000000080);
			ReturnFunction->Bind();
			ReturnFunction->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnFunction->GetOutermost()->GetMetaData();
	...
	UFunction* Z_Construct_UFunction_UFMODAudioComponent_SetProgrammerSoundName()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("SetProgrammerSoundName"), RF_Public|RF_Transient|RF_Native) UFunction(FObjectInitializer(), NULL, 0x04020401, 65535, sizeof(FMODAudioComponent_eventSetProgrammerSoundName_Parms));
			UProperty* NewProp_Value = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("Value"), RF_Public|RF_Transient|RF_Native) UStrProperty(CPP_PROPERTY_BASE(Value, FMODAudioComponent_eventSetProgrammerSoundName_Parms), 0x0000000000000080);
			ReturnFunction->Bind();
			ReturnFunction->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnFunction->GetOutermost()->GetMetaData();
	...
	UFunction* Z_Construct_UFunction_UFMODAudioComponent_SetTimelinePosition()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("SetTimelinePosition"), RF_Public|RF_Transient|RF_Native) UFunction(FObjectInitializer(), NULL, 0x04020401, 65535, sizeof(FMODAudioComponent_eventSetTimelinePosition_Parms));
			UProperty* NewProp_Time = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("Time"), RF_Public|RF_Transient|RF_Native) UIntProperty(CPP_PROPERTY_BASE(Time, FMODAudioComponent_eventSetTimelinePosition_Parms), 0x0000000000000080);
			ReturnFunction->Bind();
			ReturnFunction->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnFunction->GetOutermost()->GetMetaData();
	...
	UFunction* Z_Construct_UFunction_UFMODAudioComponent_SetVolume()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("SetVolume"), RF_Public|RF_Transient|RF_Native) UFunction(FObjectInitializer(), NULL, 0x04020401, 65535, sizeof(FMODAudioComponent_eventSetVolume_Parms));
			UProperty* NewProp_volume = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("volume"), RF_Public|RF_Transient|RF_Native) UFloatProperty(CPP_PROPERTY_BASE(volume, FMODAudioComponent_eventSetVolume_Parms), 0x0000000000000080);
			ReturnFunction->Bind();
			ReturnFunction->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnFunction->GetOutermost()->GetMetaData();
	...
	UFunction* Z_Construct_UFunction_UFMODAudioComponent_TriggerCue()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("TriggerCue"), RF_Public|RF_Transient|RF_Native) UFunction(FObjectInitializer(), NULL, 0x04020401, 65535);
			ReturnFunction->Bind();
			ReturnFunction->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnFunction->GetOutermost()->GetMetaData();
	...
	UClass* Z_Construct_UClass_UFMODAudioComponent()
	{
		...
		if (!OuterClass)
		{
			...
			Z_Construct_UPackage_FMODStudio();
...
PRAGMA_DISABLE_DEPRECATION_WARNINGS
				UProperty* NewProp_ProgrammerSoundName = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("ProgrammerSoundName"), RF_Public|RF_Transient|RF_Native) UStrProperty(CPP_PROPERTY_BASE(ProgrammerSoundName, UFMODAudioComponent), 0x0000000000000005);
				UProperty* NewProp_OnTimelineBeat = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("OnTimelineBeat"), RF_Public|RF_Transient|RF_Native) UMulticastDelegateProperty(CPP_PROPERTY_BASE(OnTimelineBeat, UFMODAudioComponent), 0x0000000010080000, Z_Construct_UDelegateFunction_FMODStudio_OnTimelineBeat__DelegateSignature());
				UProperty* NewProp_OnTimelineMarker = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("OnTimelineMarker"), RF_Public|RF_Transient|RF_Native) UMulticastDelegateProperty(CPP_PROPERTY_BASE(OnTimelineMarker, UFMODAudioComponent), 0x0000000010080000, Z_Construct_UDelegateFunction_FMODStudio_OnTimelineMarker__DelegateSignature());
				UProperty* NewProp_OnEventStopped = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("OnEventStopped"), RF_Public|RF_Transient|RF_Native) UMulticastDelegateProperty(CPP_PROPERTY_BASE(OnEventStopped, UFMODAudioComponent), 0x0000000010080000, Z_Construct_UDelegateFunction_FMODStudio_OnEventStopped__DelegateSignature());
				CPP_BOOL_PROPERTY_BITMASK_STRUCT(bStopWhenOwnerDestroyed, UFMODAudioComponent, uint8);
				UProperty* NewProp_bStopWhenOwnerDestroyed = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("bStopWhenOwnerDestroyed"), RF_Public|RF_Transient|RF_Native) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(bStopWhenOwnerDestroyed, UFMODAudioComponent), 0x0000000000000000, CPP_BOOL_PROPERTY_BITMASK(bStopWhenOwnerDestroyed, UFMODAudioComponent), sizeof(uint8), false);
				CPP_BOOL_PROPERTY_BITMASK_STRUCT(bAutoDestroy, UFMODAudioComponent, uint8);
				UProperty* NewProp_bAutoDestroy = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("bAutoDestroy"), RF_Public|RF_Transient|RF_Native) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(bAutoDestroy, UFMODAudioComponent), 0x0000000000000000, CPP_BOOL_PROPERTY_BITMASK(bAutoDestroy, UFMODAudioComponent), sizeof(uint8), false);
				CPP_BOOL_PROPERTY_BITMASK_STRUCT(bEnableTimelineCallbacks, UFMODAudioComponent, uint8);
				UProperty* NewProp_bEnableTimelineCallbacks = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("bEnableTimelineCallbacks"), RF_Public|RF_Transient|RF_Native) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(bEnableTimelineCallbacks, UFMODAudioComponent), 0x0000000000000001, CPP_BOOL_PROPERTY_BITMASK(bEnableTimelineCallbacks, UFMODAudioComponent), sizeof(uint8), false);
				UProperty* NewProp_Event = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("Event"), RF_Public|RF_Transient|RF_Native) UAssetObjectProperty(CPP_PROPERTY_BASE(Event, UFMODAudioComponent), 0x0004000000000005, Z_Construct_UClass_UFMODEvent_NoRegister());
PRAGMA_ENABLE_DEPRECATION_WARNINGS
				OuterClass->AddFunctionToFunctionMap(Z_Construct_UFunction_UFMODAudioComponent_GetParameter()); // 3611999106
				OuterClass->AddFunctionToFunctionMap(Z_Construct_UFunction_UFMODAudioComponent_GetTimelinePosition()); // 3168428308
				OuterClass->AddFunctionToFunctionMap(Z_Construct_UFunction_UFMODAudioComponent_IsPlaying()); // 2771971237
				OuterClass->AddFunctionToFunctionMap(Z_Construct_UFunction_UFMODAudioComponent_Play()); // 1012719849
				OuterClass->AddFunctionToFunctionMap(Z_Construct_UFunction_UFMODAudioComponent_SetEvent()); // 4168882333
				OuterClass->AddFunctionToFunctionMap(Z_Construct_UFunction_UFMODAudioComponent_SetParameter()); // 4118307855
				OuterClass->AddFunctionToFunctionMap(Z_Construct_UFunction_UFMODAudioComponent_SetPaused()); // 1639052856
				OuterClass->AddFunctionToFunctionMap(Z_Construct_UFunction_UFMODAudioComponent_SetPitch()); // 3037522518
				OuterClass->AddFunctionToFunctionMap(Z_Construct_UFunction_UFMODAudioComponent_SetProgrammerSoundName()); // 2788992584
				OuterClass->AddFunctionToFunctionMap(Z_Construct_UFunction_UFMODAudioComponent_SetTimelinePosition()); // 1920963206
				OuterClass->AddFunctionToFunctionMap(Z_Construct_UFunction_UFMODAudioComponent_SetVolume()); // 1905348953
				OuterClass->AddFunctionToFunctionMap(Z_Construct_UFunction_UFMODAudioComponent_Stop()); // 1956140129
				OuterClass->AddFunctionToFunctionMap(Z_Construct_UFunction_UFMODAudioComponent_TriggerCue()); // 3495762212
	...
	static FCompiledInDefer Z_CompiledInDefer_UClass_UFMODAudioComponent(Z_Construct_UClass_UFMODAudioComponent, TEXT("UFMODAudioComponent"));
...
PRAGMA_DISABLE_DEPRECATION_WARNINGS
				UProperty* NewProp_AudioComponent = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("AudioComponent"), RF_Public|RF_Transient|RF_Native) UObjectProperty(CPP_PROPERTY_BASE(AudioComponent, AFMODAmbientSound), 0x00000000000a001d, Z_Construct_UClass_UFMODAudioComponent_NoRegister());
PRAGMA_ENABLE_DEPRECATION_WARNINGS
				OuterClass->StaticLink();
#if WITH_METADATA
				UMetaData* MetaData = OuterClass->GetOutermost()->GetMetaData();
	...
	static FCompiledInDefer Z_CompiledInDefer_UClass_AFMODAmbientSound(Z_Construct_UClass_AFMODAmbientSound, TEXT("AFMODAmbientSound"));
...
PRAGMA_DISABLE_DEPRECATION_WARNINGS
				...
				UProperty* NewProp_bShowAsAsset = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("bShowAsAsset"), RF_Public|RF_Transient|RF_Native) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(bShowAsAsset, UFMODAsset), 0x0000000000000000, CPP_BOOL_PROPERTY_BITMASK(bShowAsAsset, UFMODAsset), sizeof(bool), true);
				UProperty* NewProp_AssetGuid = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("AssetGuid"), RF_Public|RF_Transient|RF_Native) UStructProperty(CPP_PROPERTY_BASE(AssetGuid, UFMODAsset), 0x0000000000000000, Z_Construct_UScriptStruct_FGuid());
PRAGMA_ENABLE_DEPRECATION_WARNINGS
				OuterClass->StaticLink();
#if WITH_METADATA
				UMetaData* MetaData = OuterClass->GetOutermost()->GetMetaData();
	...
	static FCompiledInDefer Z_CompiledInDefer_UClass_UFMODAsset(Z_Construct_UClass_UFMODAsset, TEXT("UFMODAsset"));
	...
	static FCompiledInDefer Z_CompiledInDefer_UClass_UFMODBank(Z_Construct_UClass_UFMODBank, TEXT("UFMODBank"));
	...
	static FCompiledInDefer Z_CompiledInDefer_UClass_UFMODBus(Z_Construct_UClass_UFMODBus, TEXT("UFMODBus"));
	...
	static FCompiledInDefer Z_CompiledInDefer_UClass_UFMODEvent(Z_Construct_UClass_UFMODEvent, TEXT("UFMODEvent"));
	...
	static FCompiledInDefer Z_CompiledInDefer_UClass_UFMODSnapshot(Z_Construct_UClass_UFMODSnapshot, TEXT("UFMODSnapshot"));
	...
	static FCompiledInDefer Z_CompiledInDefer_UClass_UFMODVCA(Z_Construct_UClass_UFMODVCA, TEXT("UFMODVCA"));
	DEFINE_VTABLE_PTR_HELPER_CTOR(UFMODVCA);
	UScriptStruct* Z_Construct_UScriptStruct_FFMODEventInstance()
	{
		UPackage* Outer=Z_Construct_UPackage_FMODStudio();
		extern uint32 Get_Z_Construct_UScriptStruct_FFMODEventInstance_CRC();
		static UScriptStruct* ReturnStruct = FindExistingStructIfHotReload(Outer, TEXT("FMODEventInstance"), sizeof(FFMODEventInstance), Get_Z_Construct_UScriptStruct_FFMODEventInstance_CRC());
		if (!ReturnStruct)
		{
			ReturnStruct = new(EC_InternalUseOnlyConstructor, Outer, TEXT("FMODEventInstance"), RF_Public|RF_Transient|RF_Native) UScriptStruct(FObjectInitializer(), NULL, new UScriptStruct::TCppStructOps<FFMODEventInstance>, EStructFlags(0x00000001));
	...
	uint32 Get_Z_Construct_UScriptStruct_FFMODEventInstance_CRC() { return 889682499U; }
	UFunction* Z_Construct_UFunction_UFMODBlueprintStatics_BusSetFaderLevel()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("BusSetFaderLevel"), RF_Public|RF_Transient|RF_Native) UFunction(FObjectInitializer(), NULL, 0x04022401, 65535, sizeof(FMODBlueprintStatics_eventBusSetFaderLevel_Parms));
			UProperty* NewProp_Level = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("Level"), RF_Public|RF_Transient|RF_Native) UFloatProperty(CPP_PROPERTY_BASE(Level, FMODBlueprintStatics_eventBusSetFaderLevel_Parms), 0x0000000000000080);
			UProperty* NewProp_Bus = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("Bus"), RF_Public|RF_Transient|RF_Native) UObjectProperty(CPP_PROPERTY_BASE(Bus, FMODBlueprintStatics_eventBusSetFaderLevel_Parms), 0x0000000000000080, Z_Construct_UClass_UFMODBus_NoRegister());
			ReturnFunction->Bind();
			ReturnFunction->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnFunction->GetOutermost()->GetMetaData();
	...
	UFunction* Z_Construct_UFunction_UFMODBlueprintStatics_BusSetMute()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("BusSetMute"), RF_Public|RF_Transient|RF_Native) UFunction(FObjectInitializer(), NULL, 0x04022401, 65535, sizeof(FMODBlueprintStatics_eventBusSetMute_Parms));
			CPP_BOOL_PROPERTY_BITMASK_STRUCT(bMute, FMODBlueprintStatics_eventBusSetMute_Parms, bool);
			UProperty* NewProp_bMute = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("bMute"), RF_Public|RF_Transient|RF_Native) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(bMute, FMODBlueprintStatics_eventBusSetMute_Parms), 0x0000000000000080, CPP_BOOL_PROPERTY_BITMASK(bMute, FMODBlueprintStatics_eventBusSetMute_Parms), sizeof(bool), true);
			UProperty* NewProp_Bus = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("Bus"), RF_Public|RF_Transient|RF_Native) UObjectProperty(CPP_PROPERTY_BASE(Bus, FMODBlueprintStatics_eventBusSetMute_Parms), 0x0000000000000080, Z_Construct_UClass_UFMODBus_NoRegister());
			ReturnFunction->Bind();
			ReturnFunction->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnFunction->GetOutermost()->GetMetaData();
	...
	UFunction* Z_Construct_UFunction_UFMODBlueprintStatics_BusSetPaused()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("BusSetPaused"), RF_Public|RF_Transient|RF_Native) UFunction(FObjectInitializer(), NULL, 0x04022401, 65535, sizeof(FMODBlueprintStatics_eventBusSetPaused_Parms));
			CPP_BOOL_PROPERTY_BITMASK_STRUCT(bPaused, FMODBlueprintStatics_eventBusSetPaused_Parms, bool);
			UProperty* NewProp_bPaused = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("bPaused"), RF_Public|RF_Transient|RF_Native) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(bPaused, FMODBlueprintStatics_eventBusSetPaused_Parms), 0x0000000000000080, CPP_BOOL_PROPERTY_BITMASK(bPaused, FMODBlueprintStatics_eventBusSetPaused_Parms), sizeof(bool), true);
			UProperty* NewProp_Bus = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("Bus"), RF_Public|RF_Transient|RF_Native) UObjectProperty(CPP_PROPERTY_BASE(Bus, FMODBlueprintStatics_eventBusSetPaused_Parms), 0x0000000000000080, Z_Construct_UClass_UFMODBus_NoRegister());
			ReturnFunction->Bind();
			ReturnFunction->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnFunction->GetOutermost()->GetMetaData();
	...
	UFunction* Z_Construct_UFunction_UFMODBlueprintStatics_EventInstanceGetParameter()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("EventInstanceGetParameter"), RF_Public|RF_Transient|RF_Native) UFunction(FObjectInitializer(), NULL, 0x04022401, 65535, sizeof(FMODBlueprintStatics_eventEventInstanceGetParameter_Parms));
			UProperty* NewProp_ReturnValue = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("ReturnValue"), RF_Public|RF_Transient|RF_Native) UFloatProperty(CPP_PROPERTY_BASE(ReturnValue, FMODBlueprintStatics_eventEventInstanceGetParameter_Parms), 0x0000000000000580);
			UProperty* NewProp_Name = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("Name"), RF_Public|RF_Transient|RF_Native) UNameProperty(CPP_PROPERTY_BASE(Name, FMODBlueprintStatics_eventEventInstanceGetParameter_Parms), 0x0000000000000080);
			UProperty* NewProp_EventInstance = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("EventInstance"), RF_Public|RF_Transient|RF_Native) UStructProperty(CPP_PROPERTY_BASE(EventInstance, FMODBlueprintStatics_eventEventInstanceGetParameter_Parms), 0x0000000000000080, Z_Construct_UScriptStruct_FFMODEventInstance());
			ReturnFunction->Bind();
			ReturnFunction->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnFunction->GetOutermost()->GetMetaData();
	...
	UFunction* Z_Construct_UFunction_UFMODBlueprintStatics_EventInstanceIsValid()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("EventInstanceIsValid"), RF_Public|RF_Transient|RF_Native) UFunction(FObjectInitializer(), NULL, 0x04022401, 65535, sizeof(FMODBlueprintStatics_eventEventInstanceIsValid_Parms));
			CPP_BOOL_PROPERTY_BITMASK_STRUCT(ReturnValue, FMODBlueprintStatics_eventEventInstanceIsValid_Parms, bool);
			UProperty* NewProp_ReturnValue = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("ReturnValue"), RF_Public|RF_Transient|RF_Native) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(ReturnValue, FMODBlueprintStatics_eventEventInstanceIsValid_Parms), 0x0000000000000580, CPP_BOOL_PROPERTY_BITMASK(ReturnValue, FMODBlueprintStatics_eventEventInstanceIsValid_Parms), sizeof(bool), true);
			UProperty* NewProp_EventInstance = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("EventInstance"), RF_Public|RF_Transient|RF_Native) UStructProperty(CPP_PROPERTY_BASE(EventInstance, FMODBlueprintStatics_eventEventInstanceIsValid_Parms), 0x0000000000000080, Z_Construct_UScriptStruct_FFMODEventInstance());
			ReturnFunction->Bind();
			ReturnFunction->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnFunction->GetOutermost()->GetMetaData();
	...
	UFunction* Z_Construct_UFunction_UFMODBlueprintStatics_EventInstancePlay()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("EventInstancePlay"), RF_Public|RF_Transient|RF_Native) UFunction(FObjectInitializer(), NULL, 0x04022401, 65535, sizeof(FMODBlueprintStatics_eventEventInstancePlay_Parms));
			UProperty* NewProp_EventInstance = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("EventInstance"), RF_Public|RF_Transient|RF_Native) UStructProperty(CPP_PROPERTY_BASE(EventInstance, FMODBlueprintStatics_eventEventInstancePlay_Parms), 0x0000000000000080, Z_Construct_UScriptStruct_FFMODEventInstance());
			ReturnFunction->Bind();
			ReturnFunction->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnFunction->GetOutermost()->GetMetaData();
	...
	UFunction* Z_Construct_UFunction_UFMODBlueprintStatics_EventInstanceSetParameter()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("EventInstanceSetParameter"), RF_Public|RF_Transient|RF_Native) UFunction(FObjectInitializer(), NULL, 0x04022401, 65535, sizeof(FMODBlueprintStatics_eventEventInstanceSetParameter_Parms));
			UProperty* NewProp_Value = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("Value"), RF_Public|RF_Transient|RF_Native) UFloatProperty(CPP_PROPERTY_BASE(Value, FMODBlueprintStatics_eventEventInstanceSetParameter_Parms), 0x0000000000000080);
			UProperty* NewProp_Name = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("Name"), RF_Public|RF_Transient|RF_Native) UNameProperty(CPP_PROPERTY_BASE(Name, FMODBlueprintStatics_eventEventInstanceSetParameter_Parms), 0x0000000000000080);
			UProperty* NewProp_EventInstance = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("EventInstance"), RF_Public|RF_Transient|RF_Native) UStructProperty(CPP_PROPERTY_BASE(EventInstance, FMODBlueprintStatics_eventEventInstanceSetParameter_Parms), 0x0000000000000080, Z_Construct_UScriptStruct_FFMODEventInstance());
			ReturnFunction->Bind();
			ReturnFunction->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnFunction->GetOutermost()->GetMetaData();
	...
	UFunction* Z_Construct_UFunction_UFMODBlueprintStatics_EventInstanceSetPaused()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("EventInstanceSetPaused"), RF_Public|RF_Transient|RF_Native) UFunction(FObjectInitializer(), NULL, 0x04022401, 65535, sizeof(FMODBlueprintStatics_eventEventInstanceSetPaused_Parms));
			CPP_BOOL_PROPERTY_BITMASK_STRUCT(Paused, FMODBlueprintStatics_eventEventInstanceSetPaused_Parms, bool);
			UProperty* NewProp_Paused = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("Paused"), RF_Public|RF_Transient|RF_Native) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(Paused, FMODBlueprintStatics_eventEventInstanceSetPaused_Parms), 0x0000000000000080, CPP_BOOL_PROPERTY_BITMASK(Paused, FMODBlueprintStatics_eventEventInstanceSetPaused_Parms), sizeof(bool), true);
			UProperty* NewProp_EventInstance = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("EventInstance"), RF_Public|RF_Transient|RF_Native) UStructProperty(CPP_PROPERTY_BASE(EventInstance, FMODBlueprintStatics_eventEventInstanceSetPaused_Parms), 0x0000000000000080, Z_Construct_UScriptStruct_FFMODEventInstance());
			ReturnFunction->Bind();
			ReturnFunction->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnFunction->GetOutermost()->GetMetaData();
	...
	UFunction* Z_Construct_UFunction_UFMODBlueprintStatics_EventInstanceSetPitch()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("EventInstanceSetPitch"), RF_Public|RF_Transient|RF_Native) UFunction(FObjectInitializer(), NULL, 0x04022401, 65535, sizeof(FMODBlueprintStatics_eventEventInstanceSetPitch_Parms));
			UProperty* NewProp_Pitch = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("Pitch"), RF_Public|RF_Transient|RF_Native) UFloatProperty(CPP_PROPERTY_BASE(Pitch, FMODBlueprintStatics_eventEventInstanceSetPitch_Parms), 0x0000000000000080);
			UProperty* NewProp_EventInstance = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("EventInstance"), RF_Public|RF_Transient|RF_Native) UStructProperty(CPP_PROPERTY_BASE(EventInstance, FMODBlueprintStatics_eventEventInstanceSetPitch_Parms), 0x0000000000000080, Z_Construct_UScriptStruct_FFMODEventInstance());
			ReturnFunction->Bind();
			ReturnFunction->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnFunction->GetOutermost()->GetMetaData();
	...
	UFunction* Z_Construct_UFunction_UFMODBlueprintStatics_EventInstanceSetTransform()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("EventInstanceSetTransform"), RF_Public|RF_Transient|RF_Native) UFunction(FObjectInitializer(), NULL, 0x04C22401, 65535, sizeof(FMODBlueprintStatics_eventEventInstanceSetTransform_Parms));
			UProperty* NewProp_Location = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("Location"), RF_Public|RF_Transient|RF_Native) UStructProperty(CPP_PROPERTY_BASE(Location, FMODBlueprintStatics_eventEventInstanceSetTransform_Parms), 0x0000000008000182, Z_Construct_UScriptStruct_FTransform());
			UProperty* NewProp_EventInstance = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("EventInstance"), RF_Public|RF_Transient|RF_Native) UStructProperty(CPP_PROPERTY_BASE(EventInstance, FMODBlueprintStatics_eventEventInstanceSetTransform_Parms), 0x0000000000000080, Z_Construct_UScriptStruct_FFMODEventInstance());
			ReturnFunction->Bind();
			ReturnFunction->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnFunction->GetOutermost()->GetMetaData();
	...
	UFunction* Z_Construct_UFunction_UFMODBlueprintStatics_EventInstanceSetVolume()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("EventInstanceSetVolume"), RF_Public|RF_Transient|RF_Native) UFunction(FObjectInitializer(), NULL, 0x04022401, 65535, sizeof(FMODBlueprintStatics_eventEventInstanceSetVolume_Parms));
			UProperty* NewProp_Volume = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("Volume"), RF_Public|RF_Transient|RF_Native) UFloatProperty(CPP_PROPERTY_BASE(Volume, FMODBlueprintStatics_eventEventInstanceSetVolume_Parms), 0x0000000000000080);
			UProperty* NewProp_EventInstance = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("EventInstance"), RF_Public|RF_Transient|RF_Native) UStructProperty(CPP_PROPERTY_BASE(EventInstance, FMODBlueprintStatics_eventEventInstanceSetVolume_Parms), 0x0000000000000080, Z_Construct_UScriptStruct_FFMODEventInstance());
			ReturnFunction->Bind();
			ReturnFunction->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnFunction->GetOutermost()->GetMetaData();
	...
	UFunction* Z_Construct_UFunction_UFMODBlueprintStatics_EventInstanceStop()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("EventInstanceStop"), RF_Public|RF_Transient|RF_Native) UFunction(FObjectInitializer(), NULL, 0x04022401, 65535, sizeof(FMODBlueprintStatics_eventEventInstanceStop_Parms));
			UProperty* NewProp_EventInstance = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("EventInstance"), RF_Public|RF_Transient|RF_Native) UStructProperty(CPP_PROPERTY_BASE(EventInstance, FMODBlueprintStatics_eventEventInstanceStop_Parms), 0x0000000000000080, Z_Construct_UScriptStruct_FFMODEventInstance());
			ReturnFunction->Bind();
			ReturnFunction->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnFunction->GetOutermost()->GetMetaData();
	...
	UFunction* Z_Construct_UFunction_UFMODBlueprintStatics_EventInstanceTriggerCue()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("EventInstanceTriggerCue"), RF_Public|RF_Transient|RF_Native) UFunction(FObjectInitializer(), NULL, 0x04022401, 65535, sizeof(FMODBlueprintStatics_eventEventInstanceTriggerCue_Parms));
			UProperty* NewProp_EventInstance = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("EventInstance"), RF_Public|RF_Transient|RF_Native) UStructProperty(CPP_PROPERTY_BASE(EventInstance, FMODBlueprintStatics_eventEventInstanceTriggerCue_Parms), 0x0000000000000080, Z_Construct_UScriptStruct_FFMODEventInstance());
			ReturnFunction->Bind();
			ReturnFunction->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnFunction->GetOutermost()->GetMetaData();
	...
	UFunction* Z_Construct_UFunction_UFMODBlueprintStatics_FindAssetByName()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("FindAssetByName"), RF_Public|RF_Transient|RF_Native) UFunction(FObjectInitializer(), NULL, 0x04022401, 65535, sizeof(FMODBlueprintStatics_eventFindAssetByName_Parms));
			UProperty* NewProp_ReturnValue = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("ReturnValue"), RF_Public|RF_Transient|RF_Native) UObjectProperty(CPP_PROPERTY_BASE(ReturnValue, FMODBlueprintStatics_eventFindAssetByName_Parms), 0x0000000000000580, Z_Construct_UClass_UFMODAsset_NoRegister());
			UProperty* NewProp_Name = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("Name"), RF_Public|RF_Transient|RF_Native) UStrProperty(CPP_PROPERTY_BASE(Name, FMODBlueprintStatics_eventFindAssetByName_Parms), 0x0000000000000080);
			ReturnFunction->Bind();
			ReturnFunction->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnFunction->GetOutermost()->GetMetaData();
	...
	UFunction* Z_Construct_UFunction_UFMODBlueprintStatics_FindEventByName()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("FindEventByName"), RF_Public|RF_Transient|RF_Native) UFunction(FObjectInitializer(), NULL, 0x04022401, 65535, sizeof(FMODBlueprintStatics_eventFindEventByName_Parms));
			UProperty* NewProp_ReturnValue = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("ReturnValue"), RF_Public|RF_Transient|RF_Native) UObjectProperty(CPP_PROPERTY_BASE(ReturnValue, FMODBlueprintStatics_eventFindEventByName_Parms), 0x0000000000000580, Z_Construct_UClass_UFMODEvent_NoRegister());
			UProperty* NewProp_Name = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("Name"), RF_Public|RF_Transient|RF_Native) UStrProperty(CPP_PROPERTY_BASE(Name, FMODBlueprintStatics_eventFindEventByName_Parms), 0x0000000000000080);
			ReturnFunction->Bind();
			ReturnFunction->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnFunction->GetOutermost()->GetMetaData();
	...
	UFunction* Z_Construct_UFunction_UFMODBlueprintStatics_FindEventInstances()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("FindEventInstances"), RF_Public|RF_Transient|RF_Native) UFunction(FObjectInitializer(), NULL, 0x04022401, 65535, sizeof(FMODBlueprintStatics_eventFindEventInstances_Parms));
			UProperty* NewProp_ReturnValue = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("ReturnValue"), RF_Public|RF_Transient|RF_Native) UArrayProperty(CPP_PROPERTY_BASE(ReturnValue, FMODBlueprintStatics_eventFindEventInstances_Parms), 0x0000000000000580);
			UProperty* NewProp_ReturnValue_Inner = new(EC_InternalUseOnlyConstructor, NewProp_ReturnValue, TEXT("ReturnValue"), RF_Public|RF_Transient|RF_Native) UStructProperty(FObjectInitializer(), EC_CppProperty, 0, 0x0000000000000000, Z_Construct_UScriptStruct_FFMODEventInstance());
			UProperty* NewProp_Event = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("Event"), RF_Public|RF_Transient|RF_Native) UObjectProperty(CPP_PROPERTY_BASE(Event, FMODBlueprintStatics_eventFindEventInstances_Parms), 0x0000000000000080, Z_Construct_UClass_UFMODEvent_NoRegister());
			UProperty* NewProp_WorldContextObject = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("WorldContextObject"), RF_Public|RF_Transient|RF_Native) UObjectProperty(CPP_PROPERTY_BASE(WorldContextObject, FMODBlueprintStatics_eventFindEventInstances_Parms), 0x0000000000000080, Z_Construct_UClass_UObject_NoRegister());
			ReturnFunction->Bind();
			ReturnFunction->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnFunction->GetOutermost()->GetMetaData();
	...
	UFunction* Z_Construct_UFunction_UFMODBlueprintStatics_LoadBank()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("LoadBank"), RF_Public|RF_Transient|RF_Native) UFunction(FObjectInitializer(), NULL, 0x04022401, 65535, sizeof(FMODBlueprintStatics_eventLoadBank_Parms));
			CPP_BOOL_PROPERTY_BITMASK_STRUCT(bLoadSampleData, FMODBlueprintStatics_eventLoadBank_Parms, bool);
			UProperty* NewProp_bLoadSampleData = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("bLoadSampleData"), RF_Public|RF_Transient|RF_Native) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(bLoadSampleData, FMODBlueprintStatics_eventLoadBank_Parms), 0x0000000000000080, CPP_BOOL_PROPERTY_BITMASK(bLoadSampleData, FMODBlueprintStatics_eventLoadBank_Parms), sizeof(bool), true);
			CPP_BOOL_PROPERTY_BITMASK_STRUCT(bBlocking, FMODBlueprintStatics_eventLoadBank_Parms, bool);
			UProperty* NewProp_bBlocking = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("bBlocking"), RF_Public|RF_Transient|RF_Native) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(bBlocking, FMODBlueprintStatics_eventLoadBank_Parms), 0x0000000000000080, CPP_BOOL_PROPERTY_BITMASK(bBlocking, FMODBlueprintStatics_eventLoadBank_Parms), sizeof(bool), true);
			UProperty* NewProp_Bank = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("Bank"), RF_Public|RF_Transient|RF_Native) UObjectProperty(CPP_PROPERTY_BASE(Bank, FMODBlueprintStatics_eventLoadBank_Parms), 0x0000000000000080, Z_Construct_UClass_UFMODBank_NoRegister());
			ReturnFunction->Bind();
			ReturnFunction->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnFunction->GetOutermost()->GetMetaData();
	...
	UFunction* Z_Construct_UFunction_UFMODBlueprintStatics_LoadBankSampleData()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("LoadBankSampleData"), RF_Public|RF_Transient|RF_Native) UFunction(FObjectInitializer(), NULL, 0x04022401, 65535, sizeof(FMODBlueprintStatics_eventLoadBankSampleData_Parms));
			UProperty* NewProp_Bank = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("Bank"), RF_Public|RF_Transient|RF_Native) UObjectProperty(CPP_PROPERTY_BASE(Bank, FMODBlueprintStatics_eventLoadBankSampleData_Parms), 0x0000000000000080, Z_Construct_UClass_UFMODBank_NoRegister());
			ReturnFunction->Bind();
			ReturnFunction->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnFunction->GetOutermost()->GetMetaData();
	...
	UFunction* Z_Construct_UFunction_UFMODBlueprintStatics_LoadEventSampleData()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("LoadEventSampleData"), RF_Public|RF_Transient|RF_Native) UFunction(FObjectInitializer(), NULL, 0x04022401, 65535, sizeof(FMODBlueprintStatics_eventLoadEventSampleData_Parms));
			UProperty* NewProp_Event = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("Event"), RF_Public|RF_Transient|RF_Native) UObjectProperty(CPP_PROPERTY_BASE(Event, FMODBlueprintStatics_eventLoadEventSampleData_Parms), 0x0000000000000080, Z_Construct_UClass_UFMODEvent_NoRegister());
			UProperty* NewProp_WorldContextObject = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("WorldContextObject"), RF_Public|RF_Transient|RF_Native) UObjectProperty(CPP_PROPERTY_BASE(WorldContextObject, FMODBlueprintStatics_eventLoadEventSampleData_Parms), 0x0000000000000080, Z_Construct_UClass_UObject_NoRegister());
			ReturnFunction->Bind();
			ReturnFunction->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnFunction->GetOutermost()->GetMetaData();
	...
	UFunction* Z_Construct_UFunction_UFMODBlueprintStatics_PlayEvent2D()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("PlayEvent2D"), RF_Public|RF_Transient|RF_Native) UFunction(FObjectInitializer(), NULL, 0x04022401, 65535, sizeof(FMODBlueprintStatics_eventPlayEvent2D_Parms));
			UProperty* NewProp_ReturnValue = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("ReturnValue"), RF_Public|RF_Transient|RF_Native) UStructProperty(CPP_PROPERTY_BASE(ReturnValue, FMODBlueprintStatics_eventPlayEvent2D_Parms), 0x0000000000000580, Z_Construct_UScriptStruct_FFMODEventInstance());
			CPP_BOOL_PROPERTY_BITMASK_STRUCT(bAutoPlay, FMODBlueprintStatics_eventPlayEvent2D_Parms, bool);
			UProperty* NewProp_bAutoPlay = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("bAutoPlay"), RF_Public|RF_Transient|RF_Native) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(bAutoPlay, FMODBlueprintStatics_eventPlayEvent2D_Parms), 0x0000040000000080, CPP_BOOL_PROPERTY_BITMASK(bAutoPlay, FMODBlueprintStatics_eventPlayEvent2D_Parms), sizeof(bool), true);
			UProperty* NewProp_Event = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("Event"), RF_Public|RF_Transient|RF_Native) UObjectProperty(CPP_PROPERTY_BASE(Event, FMODBlueprintStatics_eventPlayEvent2D_Parms), 0x0000000000000080, Z_Construct_UClass_UFMODEvent_NoRegister());
			UProperty* NewProp_WorldContextObject = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("WorldContextObject"), RF_Public|RF_Transient|RF_Native) UObjectProperty(CPP_PROPERTY_BASE(WorldContextObject, FMODBlueprintStatics_eventPlayEvent2D_Parms), 0x0000000000000080, Z_Construct_UClass_UObject_NoRegister());
			ReturnFunction->Bind();
			ReturnFunction->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnFunction->GetOutermost()->GetMetaData();
	...
	UFunction* Z_Construct_UFunction_UFMODBlueprintStatics_PlayEventAtLocation()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("PlayEventAtLocation"), RF_Public|RF_Transient|RF_Native) UFunction(FObjectInitializer(), NULL, 0x04C22401, 65535, sizeof(FMODBlueprintStatics_eventPlayEventAtLocation_Parms));
			UProperty* NewProp_ReturnValue = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("ReturnValue"), RF_Public|RF_Transient|RF_Native) UStructProperty(CPP_PROPERTY_BASE(ReturnValue, FMODBlueprintStatics_eventPlayEventAtLocation_Parms), 0x0000000000000580, Z_Construct_UScriptStruct_FFMODEventInstance());
			CPP_BOOL_PROPERTY_BITMASK_STRUCT(bAutoPlay, FMODBlueprintStatics_eventPlayEventAtLocation_Parms, bool);
			UProperty* NewProp_bAutoPlay = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("bAutoPlay"), RF_Public|RF_Transient|RF_Native) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(bAutoPlay, FMODBlueprintStatics_eventPlayEventAtLocation_Parms), 0x0000040000000080, CPP_BOOL_PROPERTY_BITMASK(bAutoPlay, FMODBlueprintStatics_eventPlayEventAtLocation_Parms), sizeof(bool), true);
			UProperty* NewProp_Location = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("Location"), RF_Public|RF_Transient|RF_Native) UStructProperty(CPP_PROPERTY_BASE(Location, FMODBlueprintStatics_eventPlayEventAtLocation_Parms), 0x0000040008000182, Z_Construct_UScriptStruct_FTransform());
			UProperty* NewProp_Event = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("Event"), RF_Public|RF_Transient|RF_Native) UObjectProperty(CPP_PROPERTY_BASE(Event, FMODBlueprintStatics_eventPlayEventAtLocation_Parms), 0x0000000000000080, Z_Construct_UClass_UFMODEvent_NoRegister());
			UProperty* NewProp_WorldContextObject = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("WorldContextObject"), RF_Public|RF_Transient|RF_Native) UObjectProperty(CPP_PROPERTY_BASE(WorldContextObject, FMODBlueprintStatics_eventPlayEventAtLocation_Parms), 0x0000000000000080, Z_Construct_UClass_UObject_NoRegister());
			ReturnFunction->Bind();
			ReturnFunction->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnFunction->GetOutermost()->GetMetaData();
	...
	UFunction* Z_Construct_UFunction_UFMODBlueprintStatics_PlayEventAttached()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("PlayEventAttached"), RF_Public|RF_Transient|RF_Native) UFunction(FObjectInitializer(), NULL, 0x04822401, 65535, sizeof(FMODBlueprintStatics_eventPlayEventAttached_Parms));
			UProperty* NewProp_ReturnValue = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("ReturnValue"), RF_Public|RF_Transient|RF_Native) UObjectProperty(CPP_PROPERTY_BASE(ReturnValue, FMODBlueprintStatics_eventPlayEventAttached_Parms), 0x0000000000080588, Z_Construct_UClass_UFMODAudioComponent_NoRegister());
			CPP_BOOL_PROPERTY_BITMASK_STRUCT(bAutoPlay, FMODBlueprintStatics_eventPlayEventAttached_Parms, bool);
			UProperty* NewProp_bAutoPlay = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("bAutoPlay"), RF_Public|RF_Transient|RF_Native) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(bAutoPlay, FMODBlueprintStatics_eventPlayEventAttached_Parms), 0x0000040000000080, CPP_BOOL_PROPERTY_BITMASK(bAutoPlay, FMODBlueprintStatics_eventPlayEventAttached_Parms), sizeof(bool), true);
			CPP_BOOL_PROPERTY_BITMASK_STRUCT(bStopWhenAttachedToDestroyed, FMODBlueprintStatics_eventPlayEventAttached_Parms, bool);
			UProperty* NewProp_bStopWhenAttachedToDestroyed = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("bStopWhenAttachedToDestroyed"), RF_Public|RF_Transient|RF_Native) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(bStopWhenAttachedToDestroyed, FMODBlueprintStatics_eventPlayEventAttached_Parms), 0x0000040000000080, CPP_BOOL_PROPERTY_BITMASK(bStopWhenAttachedToDestroyed, FMODBlueprintStatics_eventPlayEventAttached_Parms), sizeof(bool), true);
			UProperty* NewProp_LocationType = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("LocationType"), RF_Public|RF_Transient|RF_Native) UByteProperty(CPP_PROPERTY_BASE(LocationType, FMODBlueprintStatics_eventPlayEventAttached_Parms), 0x0000040000000080, Z_Construct_UEnum_Engine_EAttachLocation());
			UProperty* NewProp_Location = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("Location"), RF_Public|RF_Transient|RF_Native) UStructProperty(CPP_PROPERTY_BASE(Location, FMODBlueprintStatics_eventPlayEventAttached_Parms), 0x0000040000000080, Z_Construct_UScriptStruct_FVector());
			UProperty* NewProp_AttachPointName = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("AttachPointName"), RF_Public|RF_Transient|RF_Native) UNameProperty(CPP_PROPERTY_BASE(AttachPointName, FMODBlueprintStatics_eventPlayEventAttached_Parms), 0x0000040000000080);
			UProperty* NewProp_AttachToComponent = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("AttachToComponent"), RF_Public|RF_Transient|RF_Native) UObjectProperty(CPP_PROPERTY_BASE(AttachToComponent, FMODBlueprintStatics_eventPlayEventAttached_Parms), 0x0000000000080080, Z_Construct_UClass_USceneComponent_NoRegister());
			UProperty* NewProp_Event = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("Event"), RF_Public|RF_Transient|RF_Native) UObjectProperty(CPP_PROPERTY_BASE(Event, FMODBlueprintStatics_eventPlayEventAttached_Parms), 0x0000000000000080, Z_Construct_UClass_UFMODEvent_NoRegister());
			ReturnFunction->Bind();
			ReturnFunction->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnFunction->GetOutermost()->GetMetaData();
	...
	UFunction* Z_Construct_UFunction_UFMODBlueprintStatics_UnloadBank()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("UnloadBank"), RF_Public|RF_Transient|RF_Native) UFunction(FObjectInitializer(), NULL, 0x04022401, 65535, sizeof(FMODBlueprintStatics_eventUnloadBank_Parms));
			UProperty* NewProp_Bank = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("Bank"), RF_Public|RF_Transient|RF_Native) UObjectProperty(CPP_PROPERTY_BASE(Bank, FMODBlueprintStatics_eventUnloadBank_Parms), 0x0000000000000080, Z_Construct_UClass_UFMODBank_NoRegister());
			ReturnFunction->Bind();
			ReturnFunction->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnFunction->GetOutermost()->GetMetaData();
	...
	UFunction* Z_Construct_UFunction_UFMODBlueprintStatics_UnloadBankSampleData()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("UnloadBankSampleData"), RF_Public|RF_Transient|RF_Native) UFunction(FObjectInitializer(), NULL, 0x04022401, 65535, sizeof(FMODBlueprintStatics_eventUnloadBankSampleData_Parms));
			UProperty* NewProp_Bank = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("Bank"), RF_Public|RF_Transient|RF_Native) UObjectProperty(CPP_PROPERTY_BASE(Bank, FMODBlueprintStatics_eventUnloadBankSampleData_Parms), 0x0000000000000080, Z_Construct_UClass_UFMODBank_NoRegister());
			ReturnFunction->Bind();
			ReturnFunction->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnFunction->GetOutermost()->GetMetaData();
	...
	UFunction* Z_Construct_UFunction_UFMODBlueprintStatics_UnloadEventSampleData()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("UnloadEventSampleData"), RF_Public|RF_Transient|RF_Native) UFunction(FObjectInitializer(), NULL, 0x04022401, 65535, sizeof(FMODBlueprintStatics_eventUnloadEventSampleData_Parms));
			UProperty* NewProp_Event = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("Event"), RF_Public|RF_Transient|RF_Native) UObjectProperty(CPP_PROPERTY_BASE(Event, FMODBlueprintStatics_eventUnloadEventSampleData_Parms), 0x0000000000000080, Z_Construct_UClass_UFMODEvent_NoRegister());
			UProperty* NewProp_WorldContextObject = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("WorldContextObject"), RF_Public|RF_Transient|RF_Native) UObjectProperty(CPP_PROPERTY_BASE(WorldContextObject, FMODBlueprintStatics_eventUnloadEventSampleData_Parms), 0x0000000000000080, Z_Construct_UClass_UObject_NoRegister());
			ReturnFunction->Bind();
			ReturnFunction->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnFunction->GetOutermost()->GetMetaData();
	...
	UClass* Z_Construct_UClass_UFMODBlueprintStatics()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				OuterClass->AddFunctionToFunctionMap(Z_Construct_UFunction_UFMODBlueprintStatics_BusSetFaderLevel()); // 2459769166
				OuterClass->AddFunctionToFunctionMap(Z_Construct_UFunction_UFMODBlueprintStatics_BusSetMute()); // 1911838575
				OuterClass->AddFunctionToFunctionMap(Z_Construct_UFunction_UFMODBlueprintStatics_BusSetPaused()); // 2218733083
				OuterClass->AddFunctionToFunctionMap(Z_Construct_UFunction_UFMODBlueprintStatics_EventInstanceGetParameter()); // 1280950965
				OuterClass->AddFunctionToFunctionMap(Z_Construct_UFunction_UFMODBlueprintStatics_EventInstanceIsValid()); // 3564556457
				OuterClass->AddFunctionToFunctionMap(Z_Construct_UFunction_UFMODBlueprintStatics_EventInstancePlay()); // 3187462306
				OuterClass->AddFunctionToFunctionMap(Z_Construct_UFunction_UFMODBlueprintStatics_EventInstanceSetParameter()); // 4039000129
				OuterClass->AddFunctionToFunctionMap(Z_Construct_UFunction_UFMODBlueprintStatics_EventInstanceSetPaused()); // 3598636142
				OuterClass->AddFunctionToFunctionMap(Z_Construct_UFunction_UFMODBlueprintStatics_EventInstanceSetPitch()); // 2173409846
				OuterClass->AddFunctionToFunctionMap(Z_Construct_UFunction_UFMODBlueprintStatics_EventInstanceSetTransform()); // 1232717840
				OuterClass->AddFunctionToFunctionMap(Z_Construct_UFunction_UFMODBlueprintStatics_EventInstanceSetVolume()); // 2980150851
				OuterClass->AddFunctionToFunctionMap(Z_Construct_UFunction_UFMODBlueprintStatics_EventInstanceStop()); // 1120685491
				OuterClass->AddFunctionToFunctionMap(Z_Construct_UFunction_UFMODBlueprintStatics_EventInstanceTriggerCue()); // 707966420
				OuterClass->AddFunctionToFunctionMap(Z_Construct_UFunction_UFMODBlueprintStatics_FindAssetByName()); // 1755259725
				OuterClass->AddFunctionToFunctionMap(Z_Construct_UFunction_UFMODBlueprintStatics_FindEventByName()); // 4278259536
				OuterClass->AddFunctionToFunctionMap(Z_Construct_UFunction_UFMODBlueprintStatics_FindEventInstances()); // 2118120062
				OuterClass->AddFunctionToFunctionMap(Z_Construct_UFunction_UFMODBlueprintStatics_LoadBank()); // 2156050492
				OuterClass->AddFunctionToFunctionMap(Z_Construct_UFunction_UFMODBlueprintStatics_LoadBankSampleData()); // 3509832095
				OuterClass->AddFunctionToFunctionMap(Z_Construct_UFunction_UFMODBlueprintStatics_LoadEventSampleData()); // 88130031
				OuterClass->AddFunctionToFunctionMap(Z_Construct_UFunction_UFMODBlueprintStatics_PlayEvent2D()); // 65182942
				OuterClass->AddFunctionToFunctionMap(Z_Construct_UFunction_UFMODBlueprintStatics_PlayEventAtLocation()); // 819722203
				OuterClass->AddFunctionToFunctionMap(Z_Construct_UFunction_UFMODBlueprintStatics_PlayEventAttached()); // 683182240
				OuterClass->AddFunctionToFunctionMap(Z_Construct_UFunction_UFMODBlueprintStatics_UnloadBank()); // 651753020
				OuterClass->AddFunctionToFunctionMap(Z_Construct_UFunction_UFMODBlueprintStatics_UnloadBankSampleData()); // 2028002145
				OuterClass->AddFunctionToFunctionMap(Z_Construct_UFunction_UFMODBlueprintStatics_UnloadEventSampleData()); // 3145593831
				OuterClass->StaticLink();
#if WITH_METADATA
				UMetaData* MetaData = OuterClass->GetOutermost()->GetMetaData();
	...
	static FCompiledInDefer Z_CompiledInDefer_UClass_UFMODBlueprintStatics(Z_Construct_UClass_UFMODBlueprintStatics, TEXT("UFMODBlueprintStatics"));
	...
	UEnum* Z_Construct_UEnum_FMODStudio_EFMODSpeakerMode()
	{
		...
		static UEnum* ReturnEnum = FindExistingEnumIfHotReload(Outer, TEXT("EFMODSpeakerMode"), 0, Get_Z_Construct_UEnum_FMODStudio_EFMODSpeakerMode_CRC());
		if (!ReturnEnum)
		{
			ReturnEnum = new(EC_InternalUseOnlyConstructor, Outer, TEXT("EFMODSpeakerMode"), RF_Public|RF_Transient|RF_Native) UEnum(FObjectInitializer());
	...
	uint32 Get_Z_Construct_UEnum_FMODStudio_EFMODSpeakerMode_CRC() { return 2441016312U; }
...
PRAGMA_DISABLE_DEPRECATION_WARNINGS
				UProperty* NewProp_SkipLoadBankName = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("SkipLoadBankName"), RF_Public|RF_Transient|RF_Native) UStrProperty(CPP_PROPERTY_BASE(SkipLoadBankName, UFMODSettings), 0x0000000000004001);
				UProperty* NewProp_MasterBankName = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("MasterBankName"), RF_Public|RF_Transient|RF_Native) UStrProperty(CPP_PROPERTY_BASE(MasterBankName, UFMODSettings), 0x0000000000004001);
				UProperty* NewProp_ForcePlatformName = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("ForcePlatformName"), RF_Public|RF_Transient|RF_Native) UStrProperty(CPP_PROPERTY_BASE(ForcePlatformName, UFMODSettings), 0x0000000000004001);
				UProperty* NewProp_ContentBrowserPrefix = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("ContentBrowserPrefix"), RF_Public|RF_Transient|RF_Native) UStrProperty(CPP_PROPERTY_BASE(ContentBrowserPrefix, UFMODSettings), 0x0000000000004001);
				UProperty* NewProp_PluginFiles = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("PluginFiles"), RF_Public|RF_Transient|RF_Native) UArrayProperty(CPP_PROPERTY_BASE(PluginFiles, UFMODSettings), 0x0000000000004001);
				UProperty* NewProp_PluginFiles_Inner = new(EC_InternalUseOnlyConstructor, NewProp_PluginFiles, TEXT("PluginFiles"), RF_Public|RF_Transient|RF_Native) UStrProperty(FObjectInitializer(), EC_CppProperty, 0, 0x0000000000004000);
				UProperty* NewProp_LiveUpdatePort = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("LiveUpdatePort"), RF_Public|RF_Transient|RF_Native) UIntProperty(CPP_PROPERTY_BASE(LiveUpdatePort, UFMODSettings), 0x0000000000004001);
				UProperty* NewProp_StudioUpdatePeriod = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("StudioUpdatePeriod"), RF_Public|RF_Transient|RF_Native) UIntProperty(CPP_PROPERTY_BASE(StudioUpdatePeriod, UFMODSettings), 0x0000000000004001);
				UProperty* NewProp_DSPBufferCount = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("DSPBufferCount"), RF_Public|RF_Transient|RF_Native) UIntProperty(CPP_PROPERTY_BASE(DSPBufferCount, UFMODSettings), 0x0000000000004001);
				UProperty* NewProp_DSPBufferLength = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("DSPBufferLength"), RF_Public|RF_Transient|RF_Native) UIntProperty(CPP_PROPERTY_BASE(DSPBufferLength, UFMODSettings), 0x0000000000004001);
				UProperty* NewProp_TotalChannelCount = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("TotalChannelCount"), RF_Public|RF_Transient|RF_Native) UIntProperty(CPP_PROPERTY_BASE(TotalChannelCount, UFMODSettings), 0x0000000000004001);
				UProperty* NewProp_RealChannelCount = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("RealChannelCount"), RF_Public|RF_Transient|RF_Native) UIntProperty(CPP_PROPERTY_BASE(RealChannelCount, UFMODSettings), 0x0000000000004001);
				CPP_BOOL_PROPERTY_BITMASK_STRUCT(bMatchHardwareSampleRate, UFMODSettings, bool);
				UProperty* NewProp_bMatchHardwareSampleRate = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("bMatchHardwareSampleRate"), RF_Public|RF_Transient|RF_Native) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(bMatchHardwareSampleRate, UFMODSettings), 0x0000000000004001, CPP_BOOL_PROPERTY_BITMASK(bMatchHardwareSampleRate, UFMODSettings), sizeof(bool), true);
				UProperty* NewProp_SampleRate = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("SampleRate"), RF_Public|RF_Transient|RF_Native) UIntProperty(CPP_PROPERTY_BASE(SampleRate, UFMODSettings), 0x0000000000004001);
				UProperty* NewProp_Vol0VirtualLevel = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("Vol0VirtualLevel"), RF_Public|RF_Transient|RF_Native) UFloatProperty(CPP_PROPERTY_BASE(Vol0VirtualLevel, UFMODSettings), 0x0000000000004001);
				CPP_BOOL_PROPERTY_BITMASK_STRUCT(bVol0Virtual, UFMODSettings, bool);
				UProperty* NewProp_bVol0Virtual = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("bVol0Virtual"), RF_Public|RF_Transient|RF_Native) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(bVol0Virtual, UFMODSettings), 0x0000000000004001, CPP_BOOL_PROPERTY_BITMASK(bVol0Virtual, UFMODSettings), sizeof(bool), true);
				UProperty* NewProp_OutputFormat = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("OutputFormat"), RF_Public|RF_Transient|RF_Native) UByteProperty(CPP_PROPERTY_BASE(OutputFormat, UFMODSettings), 0x0000000000004001, Z_Construct_UEnum_FMODStudio_EFMODSpeakerMode());
				UProperty* NewProp_BankOutputDirectory = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("BankOutputDirectory"), RF_Public|RF_Transient|RF_Native) UStructProperty(CPP_PROPERTY_BASE(BankOutputDirectory, UFMODSettings), 0x0000000000004001, Z_Construct_UScriptStruct_FDirectoryPath());
				CPP_BOOL_PROPERTY_BITMASK_STRUCT(bEnableLiveUpdate, UFMODSettings, bool);
				UProperty* NewProp_bEnableLiveUpdate = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("bEnableLiveUpdate"), RF_Public|RF_Transient|RF_Native) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(bEnableLiveUpdate, UFMODSettings), 0x0000000000004001, CPP_BOOL_PROPERTY_BITMASK(bEnableLiveUpdate, UFMODSettings), sizeof(bool), true);
				CPP_BOOL_PROPERTY_BITMASK_STRUCT(bLoadAllSampleData, UFMODSettings, bool);
				UProperty* NewProp_bLoadAllSampleData = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("bLoadAllSampleData"), RF_Public|RF_Transient|RF_Native) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(bLoadAllSampleData, UFMODSettings), 0x0000000000004001, CPP_BOOL_PROPERTY_BITMASK(bLoadAllSampleData, UFMODSettings), sizeof(bool), true);
				CPP_BOOL_PROPERTY_BITMASK_STRUCT(bLoadAllBanks, UFMODSettings, bool);
				UProperty* NewProp_bLoadAllBanks = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("bLoadAllBanks"), RF_Public|RF_Transient|RF_Native) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(bLoadAllBanks, UFMODSettings), 0x0000000000004001, CPP_BOOL_PROPERTY_BITMASK(bLoadAllBanks, UFMODSettings), sizeof(bool), true);
PRAGMA_ENABLE_DEPRECATION_WARNINGS
	...
	static FCompiledInDefer Z_CompiledInDefer_UClass_UFMODSettings(Z_Construct_UClass_UFMODSettings, TEXT("UFMODSettings"));
...
PRAGMA_DISABLE_DEPRECATION_WARNINGS
				...
				UProperty* NewProp_bShowAsAsset = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("bShowAsAsset"), RF_Public|RF_Transient|RF_Native) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(bShowAsAsset, UFMODSnapshotReverb), 0x0000000000000000, CPP_BOOL_PROPERTY_BITMASK(bShowAsAsset, UFMODSnapshotReverb), sizeof(bool), true);
				UProperty* NewProp_AssetGuid = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("AssetGuid"), RF_Public|RF_Transient|RF_Native) UStructProperty(CPP_PROPERTY_BASE(AssetGuid, UFMODSnapshotReverb), 0x0000000000000000, Z_Construct_UScriptStruct_FGuid());
PRAGMA_ENABLE_DEPRECATION_WARNINGS
				OuterClass->StaticLink();
#if WITH_METADATA
				UMetaData* MetaData = OuterClass->GetOutermost()->GetMetaData();
	...
	static FCompiledInDefer Z_CompiledInDefer_UClass_UFMODSnapshotReverb(Z_Construct_UClass_UFMODSnapshotReverb, TEXT("UFMODSnapshotReverb"));
	DEFINE_VTABLE_PTR_HELPER_CTOR(UFMODSnapshotReverb);
	UPackage* Z_Construct_UPackage_FMODStudio()
	{
