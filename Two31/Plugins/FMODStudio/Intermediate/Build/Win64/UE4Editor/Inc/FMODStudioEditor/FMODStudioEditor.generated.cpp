...
void EmptyLinkFunctionForGeneratedCodeFMODStudioEditor() {}
	void UFMODAmbientSoundActorFactory::StaticRegisterNativesUFMODAmbientSoundActorFactory()
	{
	}
	IMPLEMENT_CLASS(UFMODAmbientSoundActorFactory, 416428547);
...
// Cross Module References
	...
	FMODSTUDIOEDITOR_API class UPackage* Z_Construct_UPackage_FMODStudioEditor();
	...
	UClass* Z_Construct_UClass_UFMODAmbientSoundActorFactory()
	{
		...
		if (!OuterClass)
		{
			...
			Z_Construct_UPackage_FMODStudioEditor();
	...
	static FCompiledInDefer Z_CompiledInDefer_UClass_UFMODAmbientSoundActorFactory(Z_Construct_UClass_UFMODAmbientSoundActorFactory, TEXT("UFMODAmbientSoundActorFactory"));
	DEFINE_VTABLE_PTR_HELPER_CTOR(UFMODAmbientSoundActorFactory);
	UPackage* Z_Construct_UPackage_FMODStudioEditor()
	{
